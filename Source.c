...
void main()
{
	...
	// 유효숫자를 나타내는 가수와 소수점의 위치를 풀이하는 지수로 나누어 표현하는 방법입니다.
	// [1]  [8]  [23] <- 4 byte (정밀도 소수점 6자릿수)
	// [1]  [11] [52] <- 8 byte (정밀도 소수점 15자릿수)
	// 부호 지수  가수
	...
	// 3 + bais = (float 127), (double 1023)
	// 3 + 127 = 130
	// 1000 0010
	 
	// [0] [10000010] [1000101000000000000]
	...
	// else if문은 if문의 조건이 거짓이라면 조건을 비교하여 실행하는 조건문입니다.
	...
	// else : if문의 조건과 else if문의 조건 둘다 거짓이라면 실행되는 조건문입니다.
	else
	{
