...
void main()
{
	...
	*/
	...
	// switch
	// 어떤 결과에 따라 그 결과부터 실행 되는 조건문 입니다.
	/*
	float variable = 3.25;
	...
	*/
	...
	switch (alphabet)
	{
		case 'A': printf("100 점 ~ 90 점");
			break;
		case 'B': printf("90 점 ~ 80 점");
			break;
		case 'C': printf("80 점 ~ 70 점");
			break;
		case 'D': printf("70 점 ~ 60 점");
			break;
		case 'E': printf("60 점 ~ 50 점");
			break;
