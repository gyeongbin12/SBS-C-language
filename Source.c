...
// 매개 변수가 포인터로 선언되면, 변수의 주소를 전달해야합니다.
void Swap(int * x, int * y)
{
	// x만 출력하는 포인터 변신 x(주소)만 출력합니다.
	// 그래서 *(애스터리스크) 여난자를 사용하여 메모리에 접근하여 값을 출력합니다.
	int temp = *x;
...
void main()
{
	// 참조에 의한 호출
	/*
	// 함수 호풀 시 전달되는 변수의 주소를 함수의 인수로 전달하는 방법입니다.
	int x = 10;
	int y = 20;

	printf("x 변수 : %d y 변수의 값 : %d\n", x, y);
	...
	*/
	...
	// 3. 그다음 컴퓨터가 뽑은 랜덤한 숫자와 
	// 우리가 입력한 숫자가 맞는지 확인하는 게임입니다.
